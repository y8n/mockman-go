...
exports.import = function (dirPath) {
    ...
    classNames.forEach(function (className, index) {
        ...
        if(Class.responseSync){
            responseFn = function (request, response) {
                var jsonString = Class.responseSync(createJSONObject(request)).toString();
...
function compileJavaFiles(dirPath) {
    ...
    if (result.status) {
        ...
        throw new Error('[ERROR]:error occured when compile java file error.');
    }
    return files;
}
